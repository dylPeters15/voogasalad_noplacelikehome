...
public class NewUnitPane extends BaseUIManager<Region> {
	...
	public NewUnitPane(AuthoringGameState gameState) {
...
//		abilitiesAdder.getRequests().passTo(getRequests());
		Modifier<AuthoringGameState> modifier = gameState -> {gameState.getTemplateByCategory("Units").addAll(new ModifiableUnit("NewUnitName"));
		return gameState;
		};
	...
	private void initialize(AuthoringGameState gameState) {
		...
		abilitiesAdder = new AbilitiesAdder();
