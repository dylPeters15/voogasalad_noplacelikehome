...
public class TemplatePaneFactory {
	public static final String[] TEMPLATE_CATEGORIES = new String[]{"Units", "Terrains", "ActiveAbilities", "UnitTriggeredEffects", "CellTriggeredEffects", "OffensiveModifiers", "DefensiveModifiers", "BoundsHandlers"};
