...
public final class Attack extends ActiveAbility<Unit> {
    ...
    public Attack(String name, String description, String imgPath, Double damage, int numHits, GameEngine game) {
        this(name, description, imgPath, damage, numHits, CoordinateTuple.getOrigin(game.getGrid().dimension()).getNeighbors(), game);
    }

    public Attack(String name, String description, String imgPath, Double damage, int numHits, Collection<CoordinateTuple> attackPattern, GameEngine game) {
    ...
    public Attack(String name, String description, String imgPath, Double damage, int numHits, List<InteractionModifier<Double>> damageModifiers, GameEngine game) {
    ...
    public Attack(String name, String description, String imgPath, Double damage, int numHits, Collection<CoordinateTuple> attackPattern, List<InteractionModifier<Double>> damageModifiers, GameEngine game) {
