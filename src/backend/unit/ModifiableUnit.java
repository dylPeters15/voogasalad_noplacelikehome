...
public class ModifiableUnit extends ModifiableVoogaObject<ModifiableUnit> implements Unit {
	...
	@Override
	public void moveTo(Cell destinationCell, NonAuthoringGameState gameState) {
	...
	@Override
	public void startTurn(AuthorGameState gameState) {
		processTriggers(Event.TURN_START, gameState);
	}

	@Override
	public void endTurn(AuthorGameState gameState) {
	...
	@Override
	public void useActiveAbility(ActiveAbility activeAbility, VoogaEntity target, NonAuthoringGameState gameState) {
