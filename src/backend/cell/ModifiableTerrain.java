 ...
 */
public class ModifiableTerrain extends VoogaTemplate<ModifiableTerrain> implements TerrainInstance {
	public static final int IMPASSABLE = Integer.MAX_VALUE;
	//TODO: ResourceBundlify this
	public static final TerrainInstance EMPTY = new ModifiableTerrain("Empty")
	...
	public static final TerrainInstance FLAT = new ModifiableTerrain("Flat")
	...
	public static final TerrainInstance FOREST = new ModifiableTerrain("Forest")
	...
	public static final TerrainInstance WATER = new ModifiableTerrain("Water")
	...
	public static final TerrainInstance MOUNTAIN = new ModifiableTerrain("Mountain")
			.setDefaultMoveCost(2)
	...
	public static final TerrainInstance FORTIFIED = new ModifiableTerrain("Fortified")
			.setDefaultMoveCost(1)
	...
	public boolean equals(Object obj) {
		return (obj instanceof ModifiableTerrain) && ((TerrainInstance) obj).getName().equals(this.getName());
	}
