...
public class CellAbility extends TriggeredEffect {
    ...
    public static final CellAbility FULL_HEAL = new CellAbility("Full Heal", (occupant, event, game) -> occupant.getHitPoints().resetValue(), "Units occupying this cell have their HP fully restored at the run of each turn.", "Red_Cross.png", Event.TURN_START);
    ...
    public static final CellAbility ON_FIRE = new CellAbility("On Fire", (occupant, event, game) -> occupant.takeDamage(8), "Units occupying this cell at the run of their turn take 8 damage", "My_mixtape.png", Event.TURN_START);
